...
export interface WrappedEntityModels {
  content: {
    columnNames: string[];
    commonGroupValues: {
      [key: string]: string;
...
export interface ReportGroup {
  _embedded: {
    wrappedEntityModels: WrappedEntityModels[],
  };
  page: Page;
}
...
export type PromptsCategory = "connections" | "workflows" | "mappings";

export interface PromptsAddNewRequest {
  prompt: string;
}
