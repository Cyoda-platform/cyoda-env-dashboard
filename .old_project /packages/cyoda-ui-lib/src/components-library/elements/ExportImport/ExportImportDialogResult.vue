  ...
  <div class="export-import-dialog-result">
    ...
    <div class="result-box">
      ...
      <template v-if="instance.isSuccess === false">
        ...
        <el-popover placement="top-start" title="Error" width="400" trigger="click" :content="instance.errorDesc">
          <template #reference>
        ...
        <el-button v-if="instance._solveProblemFn" :disabled="instance.isSolveLoading" @click="solveProblem"
                   type="primary" size="default" circle>
...
function solveProblem() {
  ElMessageBox.confirm('You have same item in system. If you press "Confirm" system will replace exist item by new. Continue?', "Confirm!", {
