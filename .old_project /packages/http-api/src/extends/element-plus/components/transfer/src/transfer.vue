<template>
  <div :class="ns.b()">
    ...
    <transfer-panel
      ...
      :enableSort="true"
      :strLength="strLengthRight"
      :fieldKey="fieldKey"
      :fieldLabel="fieldLabel"
    >
      <template #custom-field="{item}">
        <slot :item="item" name="custom-field"/>
      </template>
...
import {computed, getCurrentInstance, h, reactive, ref, useSlots, watch} from 'vue'
