/**
 * E2E Tests for Reporting CRUD Operations
...
test.describe('Reporting CRUD - Create Report', () => {
  ...
  test('should create a new report successfully', async ({ page }) => {
    ...
    await page.waitForURL(/\/reporting\/report-editor\/.*/, { timeout: 10000 });
    const currentUrl = page.url();
    expect(currentUrl).toContain('/reporting/report-editor/');
...
test.describe('Reporting CRUD - Edit Report', () => {
  test.beforeEach(async ({ page }) => {
    await login(page);
...
test.describe('Reporting CRUD - Clone Report', () => {
  test.beforeEach(async ({ page }) => {
    await login(page);
...
test.describe('Reporting CRUD - Delete Report', () => {
...
test.describe('Reporting CRUD - Read/View Reports', () => {
  test.beforeEach(async ({ page }) => {
    await login(page);
