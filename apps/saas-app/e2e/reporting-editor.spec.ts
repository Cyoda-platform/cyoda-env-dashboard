/**
 * E2E Tests for Report Editor Tabs
...
test.describe('Report Editor - Model Tab', () => {
  test.beforeEach(async ({ page }) => {
    await login(page);
    await setEntityType(page, 'BUSINESS');
  });
...
test.describe('Report Editor - FilterBuilder Tab', () => {
  test.beforeEach(async ({ page }) => {
    await login(page);
    await setEntityType(page, 'BUSINESS');
  });
...
test.describe('Report Editor - Action Buttons', () => {
  test.beforeEach(async ({ page }) => {
    await login(page);
    await setEntityType(page, 'BUSINESS');
  });
  ...
  test('should navigate back when clicking Back button', async ({ page }) => {
    ...
    await page.waitForURL(/\/reporting\/reports/, { timeout: 10000 });
