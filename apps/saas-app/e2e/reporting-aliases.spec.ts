/**
 * E2E Tests for Catalogue of Aliases CRUD Operations
...
test.describe('Catalogue of Aliases - Create', () => {
...
test.describe('Catalogue of Aliases - Edit', () => {
  test.beforeEach(async ({ page }) => {
    await login(page);
...
test.describe('Catalogue of Aliases - Delete', () => {
  test.beforeEach(async ({ page }) => {
    await login(page);
...
test.describe('Catalogue of Aliases - Filtering', () => {
  test.beforeEach(async ({ page }) => {
    await login(page);
...
test.describe('Catalogue of Aliases - Export/Import', () => {
  test.beforeEach(async ({ page }) => {
    await login(page);
...
test.describe('Catalogue of Aliases - Read/View', () => {
  test.beforeEach(async ({ page }) => {
    await login(page);
