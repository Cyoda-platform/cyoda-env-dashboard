/**
 * E2E Tests for Reporting Features
...
test.describe('Reports - Real Backend', () => {
  test.beforeEach(async ({ page }) => {
    // Login before each test
    await login(page);
  });

  test('should load reporting reports page successfully', async ({ page }) => {
    ...
    console.log('✓ Reporting reports page loaded');
  });
...
test.describe('Stream Reports - Real Backend', () => {
  ...
  test('should load stream reports page successfully', async ({ page }) => {
    await page.goto('/reporting/reports/stream');
    await page.waitForLoadState('networkidle');
...
test.describe('Catalogue of Aliases - Real Backend', () => {
  ...
  test('should load catalogue of aliases page successfully', async ({ page }) => {
    await page.goto('/reporting/catalogue-of-aliases');
    await page.waitForLoadState('networkidle');
...
test.describe('Reporting Navigation - Real Backend', () => {
  test.beforeEach(async ({ page }) => {
    // Login before each test
    await login(page);
  });

  test('should navigate between reporting pages via menu', async ({ page }) => {
    await page.goto('/reporting/reports');
    await page.waitForLoadState('networkidle');
  ...
  test('should be able to access all reporting routes', async ({ page }) => {
    const routes = [
      '/reporting/reports',
      '/reporting/reports/stream',
      '/reporting/catalogue-of-aliases',
    ];
...
test.describe('Reporting Integration - Real Backend', () => {
  test.beforeEach(async ({ page }) => {
    // Login before each test
    await login(page);
  });

  test('should check for console errors on reporting pages', async ({ page }) => {
    const errors: string[] = [];
  ...
  test('should verify reporting pages work with real backend data', async ({ page }) => {
    await page.goto('/reporting/reports');
    await page.waitForLoadState('networkidle');
  ...
  test('should handle backend errors gracefully', async ({ page }) => {
    ...
    await page.goto('/reporting/report-editor/invalid-id-12345');
    await page.waitForLoadState('networkidle');
    await page.waitForTimeout(2000);
