/**
 * E2E Tests for Reporting UI Interactions
...
test.describe('Reporting UI - Tab Switching', () => {
...
test.describe('Reporting UI - Table Sorting', () => {
  test.beforeEach(async ({ page }) => {
    await login(page);
    await setEntityType(page, 'BUSINESS');
  });
...
test.describe('Reporting UI - Table Pagination', () => {
  test.beforeEach(async ({ page }) => {
    await login(page);
    await setEntityType(page, 'BUSINESS');
  });
...
test.describe('Reporting UI - Search and Filter', () => {
  test.beforeEach(async ({ page }) => {
    await login(page);
    await setEntityType(page, 'BUSINESS');
  });
