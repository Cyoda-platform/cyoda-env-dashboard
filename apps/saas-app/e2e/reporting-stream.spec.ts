/**
 * E2E Tests for Stream Reports CRUD Operations
...
test.describe('Stream Reports - Create', () => {
  ...
  test('should create a new stream report successfully', async ({ page }) => {
    ...
    await page.waitForURL(/\/reporting\/reports\/stream\/.*/, { timeout: 10000 });
    const currentUrl = page.url();
    expect(currentUrl).toContain('/reporting/reports/stream/');
...
test.describe('Stream Reports - Edit', () => {
  test.beforeEach(async ({ page }) => {
    await login(page);
...
test.describe('Stream Reports - Run', () => {
  test.beforeEach(async ({ page }) => {
    await login(page);
...
test.describe('Stream Reports - Delete', () => {
  test.beforeEach(async ({ page }) => {
    await login(page);
...
test.describe('Stream Reports - Read/View', () => {
  test.beforeEach(async ({ page }) => {
    await login(page);
