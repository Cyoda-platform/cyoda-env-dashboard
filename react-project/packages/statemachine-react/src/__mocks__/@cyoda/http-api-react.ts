...
function getDefaultMockData(): MockData {
  ...
  },
  {
    ...
    active: true,
    persisted: true,
    creationDate: Date.now() - 10 * 24 * 60 * 60 * 1000, // 10 days ago
    states: ['QUEUED', 'VALIDATING', 'PROCESSING', 'COMPLETED', 'FAILED', 'RETRY'],
    initialState: 'QUEUED',
  },
    ],
    states: [
  ...
  // Workflow 4: Data Pipeline Processing states
  ...
  { id: 'state-019', name: 'FAILED', workflowId: 'workflow-004', isInitial: false, isFinal: true },
  { id: 'state-020', name: 'RETRY', workflowId: 'workflow-004', isInitial: false, isFinal: false },
    ],
    transitions: [
  {
    id: 'trans-001',
  ...
  // Workflow 4: Data Pipeline Processing transitions
  {
    id: 'trans-012',
    name: 'Start Validation',
    startStateId: 'state-015',
    endStateId: 'state-016',
    startStateName: 'QUEUED',
    endStateName: 'VALIDATING',
    automated: true,
    active: true,
    persisted: true,
  ...
  },
  {
    ...
    startStateId: 'state-016',
    endStateId: 'state-017',
    startStateName: 'VALIDATING',
    endStateName: 'PROCESSING',
    automated: true,
    active: true,
    persisted: true,
  ...
  },
  {
    ...
    startStateId: 'state-017',
    endStateId: 'state-018',
    startStateName: 'PROCESSING',
    ...
    workflowId: 'workflow-004',
    criteriaIds: [],
    endProcessesIds: ['process-006'],
  },
  {
    id: 'trans-015',
    name: 'Validation Failed',
    startStateId: 'state-016',
    endStateId: 'state-019',
    startStateName: 'VALIDATING',
    endStateName: 'FAILED',
    automated: true,
    active: true,
    ...
    workflowId: 'workflow-004',
    criteriaIds: [],
    endProcessesIds: ['process-007'],
  },
  {
    id: 'trans-016',
    name: 'Processing Failed',
    startStateId: 'state-017',
    endStateId: 'state-020',
    startStateName: 'PROCESSING',
    endStateName: 'RETRY',
    automated: true,
    active: true,
    persisted: true,
    workflowId: 'workflow-004',
    criteriaIds: ['criteria-006'],
    endProcessesIds: [],
  },
  {
    id: 'trans-017',
    name: 'Retry Processing',
    startStateId: 'state-020',
    endStateId: 'state-017',
    startStateName: 'RETRY',
    endStateName: 'PROCESSING',
    automated: true,
    active: true,
    persisted: true,
    workflowId: 'workflow-004',
    criteriaIds: ['criteria-007'],
    endProcessesIds: [],
  },
  {
    id: 'trans-018',
    ...
    persisted: true,
    workflowId: 'workflow-004',
    criteriaIds: ['criteria-008'],
    endProcessesIds: ['process-008'],
  },
    ],
    criteria: [
  ...
  { id: 'criteria-004', name: 'Queue Not Empty', description: 'Check if processing queue has items', entityClassName: 'com.cyoda.technical.DataPipeline' },
  { id: 'criteria-005', name: 'Schema Valid', description: 'Validate data schema matches expected format', entityClassName: 'com.cyoda.technical.DataPipeline' },
  { id: 'criteria-006', name: 'Transient Error', description: 'Check if error is transient and retryable', entityClassName: 'com.cyoda.technical.DataPipeline' },
  { id: 'criteria-007', name: 'Retry Count Below Max', description: 'Check if retry attempts are below maximum', entityClassName: 'com.cyoda.technical.DataPipeline' },
  { id: 'criteria-008', name: 'Max Retries Reached', description: 'Check if maximum retry attempts reached', entityClassName: 'com.cyoda.technical.DataPipeline' },
    ],
    processes: [
  ...
  { id: 'process-004', name: 'Initialize Validators', description: 'Load and initialize data validation rules', entityClassName: 'com.cyoda.technical.DataPipeline' },
  { id: 'process-005', name: 'Start Processing Engine', description: 'Initialize data processing engine and allocate resources', entityClassName: 'com.cyoda.technical.DataPipeline' },
  { id: 'process-006', name: 'Publish Results', description: 'Publish processed data to output queue', entityClassName: 'com.cyoda.technical.DataPipeline' },
  { id: 'process-007', name: 'Log Validation Error', description: 'Log validation errors to monitoring system', entityClassName: 'com.cyoda.technical.DataPipeline' },
  { id: 'process-008', name: 'Send Alert', description: 'Send alert notification for failed pipeline', entityClassName: 'com.cyoda.technical.DataPipeline' },
    ],
    instances: [
  ...
  { id: 'inst-004', workflowId: 'workflow-004', currentState: 'PROCESSING', entityId: 'pipeline-batch-001', createdAt: '2024-01-15T08:00:00Z' },
  { id: 'inst-005', workflowId: 'workflow-004', currentState: 'COMPLETED', entityId: 'pipeline-batch-002', createdAt: '2024-01-15T06:30:00Z' },
  { id: 'inst-006', workflowId: 'workflow-004', currentState: 'RETRY', entityId: 'pipeline-batch-003', createdAt: '2024-01-15T09:45:00Z' },
    ],
  };
}
