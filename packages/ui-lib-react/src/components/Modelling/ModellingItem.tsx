...
import type { ReportingInfoRow, RelatedPath, ModellingColDef as ColDef, RequestParam } from '@cyoda/http-api-react';
...
import { getReportingInfo, getReportingRelatedPaths } from '@cyoda/http-api-react';
