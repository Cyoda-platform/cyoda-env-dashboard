...
import type { EntityViewerEntity } from '@cyoda/http-api-react';

// Mock dependencies
vi.mock('../../stores/entityViewerStore');
vi.mock('@cyoda/http-api-react');
vi.mock('@cyoda/http-api-react/utils', () => ({
  HelperEntities: { getShortNameOfEntity: (name: string) => name.split('.').pop() },
}));
vi.mock('../../utils/HelperModelling', () => ({
  default: { sortData: (d: any) => d, filterData: (d: any) => d },
}));
vi.mock('../Modelling/ModellingGroup', () => ({
