/**
 * Reporting React - Main App Component
 */
...
const RouteWithLayout: React.FC<{
  ...
  if (!isPublic && !isAuthenticated) {
    return <Navigate to="/reporting/login" state={{ from: location }} replace />;
  }
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="*" element={<Navigate to="/reporting/reports" replace />} />
      </Routes>
    </>
  );
};
